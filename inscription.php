...
if($action == 'second'){
    ...
    $form->addHtml('</div>');
    $form->addHtml('<div id="error-position-company" class="alert alert-danger" style="display: none">Debe seleccionar un puesto válido.</div>');
    $form->addHtml('<div id="error-sede-company" class="alert alert-danger" style="display: none">Debe seleccionar una sede válida.</div>');
